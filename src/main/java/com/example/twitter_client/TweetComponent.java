...
public class TweetComponent extends AnchorPane {
    ...
    public TweetComponent(Message tweet, boolean hasPhoto, boolean has_liked,String username) {
        this.tweet = tweet;
        ...
        if (hasPhoto) {
            ...
            tweetImageView = new ImageView(); // Create an empty ImageView if no photo
        }
        dateLabel = new Label(tweet.getDate());
        typeOfAppLabel = new Label("Tweet id:" + tweet.getMessageId());
        ...
        if (!hasPhoto) {
            this.getChildren().addAll(usernameLabel, textArea, tweetImageView,
                    ...
                    dotsButton, separator1, separator2, replyButton, countOfReplies, replyLabel, seeReplies, profile);
        } else if (hasPhoto) {
            this.getChildren().addAll(usernameLabel, textArea, tweetImageView,
                    circleClipProfile, dateLabel, typeOfAppLabel, countOfRet, countOfLikes, countOfQuo,
                    retweetLabel, quoteLabel, likeLabel, retButton, quoteButton, likeButton,
        ...
        setActions(hasPhoto, has_liked,username);
    }
    ...
    private void setConfig(boolean hasPhoto, boolean has_liked) {
        ...
        usernameLabel.setStyle("-fx-text-fill:#3E3B3B;");
...
//            AnchorPane.setLeftAnchor(seeReplies, 130.0);
    ...
    private void setActions(boolean hasPhoto, boolean has_liked,String username) {
